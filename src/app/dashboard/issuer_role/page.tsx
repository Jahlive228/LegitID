...
import IssuerForm from "../../../components/issuer_role"
    ...
    <SidebarProvider className="flex min-h-screen">
      ...
      <SidebarInset className="flex-1">
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>Rôle Émetteur</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 flex-col p-4">
          <h1 className="text-2xl font-bold mb-4">Gestion du rôle d&apos;émetteur</h1>
